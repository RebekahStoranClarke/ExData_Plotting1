...
# Use the dmy_hms function from the lubridate package to convert ddate and time
with(data, plot(x=dmy_hms(paste(Date, Time)), Global_active_power, type="l", ylab="Global Active Power (kilowatts)", xlab=""))

# Close Graphics Device
dev.off()
# print(wday(data[1:5, "Date"]))
